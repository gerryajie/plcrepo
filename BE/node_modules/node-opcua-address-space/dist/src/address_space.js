...
class AddressSpace {
     ...
     * @private
     */
    constructEventData(eventTypeId, dataInput) {
        ...
        /* c8 ignore next */
        if (!eventTypeNode)
            throw new Error(` cannot find EventType for ${eventTypeId}`);
        ...
        if (!sourceNode) {
            warningLog(`constructEventData: cannot find sourceNode ${data.sourceNode.value?.toString()} for event ${eventTypeNode.browseName.toString()}`);
        }
     ...
     */
    addMethodCallInterceptor(interceptor) {
        (0, node_opcua_assert_1.assert)(typeof interceptor === "function");
        this._methodCallInterceptors.push(interceptor);
    }
    /**
     * Remove a previously registered method call interceptor.
     */
    removeMethodCallInterceptor(interceptor) {
