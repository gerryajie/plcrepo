...
class BaseNodeImpl extends node_events_1.EventEmitter {
    ...
    browseNodeByTargetName(relativePathElement, isLast) {
        ...
        (0, node_opcua_assert_1.assert)(Object.hasOwn(relativePathElement, "referenceTypeId"));
        // Indicates whether the inverse Reference should be followed.
        // The inverse reference is followed if this value is TRUE.
        (0, node_opcua_assert_1.assert)(Object.hasOwn(relativePathElement, "isInverse"));
        // Indicates whether subtypes of the ReferenceType should be followed.
        // Subtypes are included if this value is TRUE.
        (0, node_opcua_assert_1.assert)(Object.hasOwn(relativePathElement, "includeSubtypes"));
        ...
        for (const reference of references) {
            ...
            if ((0, node_util_1.isDeepStrictEqual)(obj.browseName, relativePathElement.targetName)) {
    ...
    removeReference(referenceOpts) {
        const _private = (0, base_node_private_1.BaseNode_getPrivate)(this);
        (0, node_opcua_assert_1.assert)(Object.hasOwn(referenceOpts, "referenceType"));
        // xx isForward is optional : assert(Object.prototype.hasOwnProperty.call(reference,"isForward"));
        (0, node_opcua_assert_1.assert)(Object.hasOwn(referenceOpts, "nodeId"));
        const addressSpace = this.addressSpace;
    ...
    toJSON() {
        return {
            ...
            nodeClass: node_opcua_data_model_1.NodeClass[this.nodeClass],
