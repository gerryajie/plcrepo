...
class UAObjectTypeImpl extends base_node_impl_1.BaseNodeImpl {
    ...
    instantiate(options) {
        ...
        (0, node_opcua_assert_1.assert)(!Object.hasOwn(options, "propertyOf"), "an Object shall not be a PropertyOf an other object");
        (0, node_opcua_assert_1.assert)(!Object.hasOwn(options, "optional"), "do you mean optionals ?");
